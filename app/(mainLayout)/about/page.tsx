export default function About() {
    return (
      <div className="max-w-4xl mx-auto px-4 py-10 text-foreground text-justify">
        ...
        <p className="mb-4 text-lg leading-relaxed">
          আমরা বিশ্বাস করি তথ্যই শক্তি, এবং সেই শক্তিকে সকল মানুষের কাছে পৌঁছে দেওয়াই আমাদের দায়িত্ব। রাজনীতি, অর্থনীতি, বিজ্ঞান, আন্তর্জাতিক, প্রযুক্তি, মতামত, এবং বিনোদনসহ বিভিন্ন বিভাগের খবর আমরা গুরুত্বের সাথে পরিবেশন করি।
        </p>
  
        <p className="mb-4 text-lg leading-relaxed">
          জাগ্রত বার্তায় কোনো ধরনের মিথ্যা বা উদ্দেশ্যপ্রণোদিত তথ্যের স্থান নেই। আমাদের সাংবাদিক ও প্রতিবেদকগণ বস্তুনিষ্ঠতা ও নিরপেক্ষতাকে সর্বোচ্চ গুরুত্ব দেন।
        </p>
